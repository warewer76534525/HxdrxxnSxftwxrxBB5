...
import com.triplelands.view.component.LinkField;
...
//			UiApplication.getUiApplication().pushScreen(new AppDataPosting("http://www.hidreensoftware.com/index.php/m/signals/test", "", this));
		}
	}
